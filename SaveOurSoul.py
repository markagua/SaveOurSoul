...
#SOUNDS
sword_slash_sound   = pygame.mixer.Sound('sounds\punch.wav')
mouse_click_sound = pygame.mixer.Sound('sounds\mouse_hover.wav')
...
def LoadingScreen():
    companyname = pygame.image.load('images/rico.png')
    DISPLAYSURF.blit(companyname, (0,0))
    pygame.display.update()
...
def Intro():
    ...
    pygame.mixer.music.load('sounds\jungle.mp3')
